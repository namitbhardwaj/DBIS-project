...
<title>Insert title here</title>
	...
	List<String> listOfCost = new ArrayList<String>();
	String locality;
	String user;
	...
	listOfPhone = (ArrayList)request.getAttribute("restaurantPhoneList");
	listOfCost = (ArrayList)request.getAttribute("restaurantCostList");
